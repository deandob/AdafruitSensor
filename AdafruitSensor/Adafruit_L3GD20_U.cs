...
//Assume sensor is mounted vertically
//Accelerometer
//Z axis will measure tilt as pitch(plane pitching forward (diving) is -10 at 90 degrees or pitchin back (climbing) is +10 at 90 degrees)
//X axis will measure roll as banking(plane banking right is +10 at +90, banking left is -10 at -90)
//Y axis is the twist, which we aren't concerned with and can't measure well due to the gravity vector.

//Gyro will give us angular velocity & acceleration. Need to add it up to get angle but there is drift
